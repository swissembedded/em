...
' Solarmax inverter data communication protocol
' Documentation google is your friend
' https://blog.dest-unreach.be/2009/04/15/solarmax-maxtalk-protocol-reverse-engineered/comment-page-2
...
' tmo%    Timeout
FUNCTION SolarmaxTransfer(itf$, sAddr%, dAddr%, cc%, fnc%, dta$, rsp$, tmo%)
